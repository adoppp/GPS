...
(() => {
  const refs = {
    openModalBtnOne: document.querySelectorAll("[data-modal-open-one]")[0],
    openModalBtnTwo: document.querySelectorAll("[data-modal-open-two]")[0],
    openModalBtnThree: document.querySelectorAll("[data-modal-open-three]")[0],
